...
<template>
    <div class="services">
        <div class="row">
            <div class="services-text col-12 text-center">
...
.cardInfo.wedding {
    background-image: url(../assets/wedding-hover-bg.jpg);
